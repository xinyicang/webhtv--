...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        filters = {}
        for k in class_type:
            classes.append({"type_name": k, "type_id": class_type[k]})
    ...
    def categoryContent(self, tid, pg, filter, extend):
        url = f"https://sou.pptv.com/category/typeid_{tid}_pn_{pg}"
...
if __name__ == "__main__":
    ...
    formatJo = sp.searchContent("电视", False, "1")  # 搜索
    # formatJo = sp.categoryContent('1', '1', False, {}) # 分类
    # formatJo = sp.detailContent(['27543999']) # 详情
    # formatJo = sp.playerContent("","27543999",{}) # 播放
